function FV2=smoothpatch(FV, modes, itt, lambda, sigma)
...
%
% FV2=smoothpatch(FV,modes,itt,lambda,sigma);
%
% Inputs,
...
%   sigma : (If modes is 0), Influence of neighbour point is 
...
if(nargin<2), modes =1; end
if(nargin<3), itt=10; end
